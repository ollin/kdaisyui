...
// Source: heroicons/src/{16,20,24}/phone.svg
...
fun FlowContent.heroIconPhone(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconPhoneOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconPhoneSolid16
            HeroIconSize.Md -> heroIconPhoneSolid20
            HeroIconSize.Lg -> heroIconPhoneSolid24
        }
    }
