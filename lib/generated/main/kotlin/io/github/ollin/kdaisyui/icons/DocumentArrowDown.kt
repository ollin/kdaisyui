...
// Source: heroicons/src/{16,20,24}/document-arrow-down.svg
...
/**
 * Document Arrow Down icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentArrowDown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentArrowDownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentArrowDownSolid16
            HeroIconSize.Md -> heroIconDocumentArrowDownSolid20
            HeroIconSize.Lg -> heroIconDocumentArrowDownSolid24
        }
    }
