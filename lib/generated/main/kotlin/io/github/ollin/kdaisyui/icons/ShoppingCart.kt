...
// Source: heroicons/src/{16,20,24}/shopping-cart.svg
 ...
 */
fun FlowContent.heroIconShoppingCart(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconShoppingCartOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconShoppingCartSolid16
            HeroIconSize.Md -> heroIconShoppingCartSolid20
            HeroIconSize.Lg -> heroIconShoppingCartSolid24
        }
    }
