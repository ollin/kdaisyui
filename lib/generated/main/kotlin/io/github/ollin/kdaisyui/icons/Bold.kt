...
// Source: heroicons/src/{16,20,24}/bold.svg
...
fun FlowContent.heroIconBold(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconBoldOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconBoldSolid16
            HeroIconSize.Md -> heroIconBoldSolid20
            HeroIconSize.Lg -> heroIconBoldSolid24
        }
    }
