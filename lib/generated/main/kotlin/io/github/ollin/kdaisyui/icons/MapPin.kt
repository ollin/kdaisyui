...
// Source: heroicons/src/{16,20,24}/map-pin.svg
 ...
 */
fun FlowContent.heroIconMapPin(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconMapPinOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconMapPinSolid16
            HeroIconSize.Md -> heroIconMapPinSolid20
            HeroIconSize.Lg -> heroIconMapPinSolid24
        }
    }
