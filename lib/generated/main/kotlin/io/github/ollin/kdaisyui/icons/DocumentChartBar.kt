...
// Source: heroicons/src/{16,20,24}/document-chart-bar.svg
...
/**
 * Document Chart Bar icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentChartBar(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentChartBarOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentChartBarSolid16
            HeroIconSize.Md -> heroIconDocumentChartBarSolid20
            HeroIconSize.Lg -> heroIconDocumentChartBarSolid24
        }
    }
