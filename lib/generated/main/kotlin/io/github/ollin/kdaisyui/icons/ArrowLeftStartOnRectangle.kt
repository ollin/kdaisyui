...
// Source: heroicons/src/{16,20,24}/arrow-left-start-on-rectangle.svg
...
/**
 * Arrow Left Start On Rectangle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowLeftStartOnRectangle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowLeftStartOnRectangleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowLeftStartOnRectangleSolid16
            HeroIconSize.Md -> heroIconArrowLeftStartOnRectangleSolid20
            HeroIconSize.Lg -> heroIconArrowLeftStartOnRectangleSolid24
        }
    }
