...
// Source: heroicons/src/{16,20,24}/flag.svg
...
fun FlowContent.heroIconFlag(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconFlagOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconFlagSolid16
            HeroIconSize.Md -> heroIconFlagSolid20
            HeroIconSize.Lg -> heroIconFlagSolid24
        }
    }
