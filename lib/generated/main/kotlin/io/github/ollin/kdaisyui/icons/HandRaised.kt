...
// Source: heroicons/src/{16,20,24}/hand-raised.svg
...
/**
 * Hand Raised icon from Heroicons.
 ...
 */
fun FlowContent.heroIconHandRaised(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconHandRaisedOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconHandRaisedSolid16
            HeroIconSize.Md -> heroIconHandRaisedSolid20
            HeroIconSize.Lg -> heroIconHandRaisedSolid24
        }
    }
