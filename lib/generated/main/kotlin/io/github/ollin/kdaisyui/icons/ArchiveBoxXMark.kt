...
// Source: heroicons/src/{16,20,24}/archive-box-x-mark.svg
...
/**
 * Archive Box X Mark icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArchiveBoxXMark(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArchiveBoxXMarkOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArchiveBoxXMarkSolid16
            HeroIconSize.Md -> heroIconArchiveBoxXMarkSolid20
            HeroIconSize.Lg -> heroIconArchiveBoxXMarkSolid24
        }
    }
