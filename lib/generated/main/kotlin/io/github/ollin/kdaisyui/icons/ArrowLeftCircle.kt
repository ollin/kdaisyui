...
// Source: heroicons/src/{16,20,24}/arrow-left-circle.svg
...
/**
 * Arrow Left Circle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowLeftCircle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowLeftCircleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowLeftCircleSolid16
            HeroIconSize.Md -> heroIconArrowLeftCircleSolid20
            HeroIconSize.Lg -> heroIconArrowLeftCircleSolid24
        }
    }
