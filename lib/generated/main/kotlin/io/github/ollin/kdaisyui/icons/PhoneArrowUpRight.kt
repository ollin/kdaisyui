...
// Source: heroicons/src/{16,20,24}/phone-arrow-up-right.svg
...
/**
 * Phone Arrow Up Right icon from Heroicons.
 ...
 */
fun FlowContent.heroIconPhoneArrowUpRight(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconPhoneArrowUpRightOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconPhoneArrowUpRightSolid16
            HeroIconSize.Md -> heroIconPhoneArrowUpRightSolid20
            HeroIconSize.Lg -> heroIconPhoneArrowUpRightSolid24
        }
    }
