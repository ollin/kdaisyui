...
enum class RangeVariant(internal val className: String) : ClassValues<RangeVariant> {
...
enum class RangeSize(internal val className: String) : ClassValues<RangeSize> {
