...
// Source: heroicons/src/{16,20,24}/chat-bubble-bottom-center.svg
...
/**
 * Chat Bubble Bottom Center icon from Heroicons.
 ...
 */
fun FlowContent.heroIconChatBubbleBottomCenter(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconChatBubbleBottomCenterOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconChatBubbleBottomCenterSolid16
            HeroIconSize.Md -> heroIconChatBubbleBottomCenterSolid20
            HeroIconSize.Lg -> heroIconChatBubbleBottomCenterSolid24
        }
    }
