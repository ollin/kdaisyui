...
// Source: heroicons/src/{16,20,24}/code-bracket-square.svg
...
/**
 * Code Bracket Square icon from Heroicons.
 ...
 */
fun FlowContent.heroIconCodeBracketSquare(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconCodeBracketSquareOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconCodeBracketSquareSolid16
            HeroIconSize.Md -> heroIconCodeBracketSquareSolid20
            HeroIconSize.Lg -> heroIconCodeBracketSquareSolid24
        }
    }
