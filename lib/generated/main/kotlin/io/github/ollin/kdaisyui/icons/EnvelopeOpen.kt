...
// Source: heroicons/src/{16,20,24}/envelope-open.svg
...
/**
 * Envelope Open icon from Heroicons.
 ...
 */
fun FlowContent.heroIconEnvelopeOpen(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconEnvelopeOpenOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconEnvelopeOpenSolid16
            HeroIconSize.Md -> heroIconEnvelopeOpenSolid20
            HeroIconSize.Lg -> heroIconEnvelopeOpenSolid24
        }
    }
