...
// Source: heroicons/src/{16,20,24}/plus-small.svg
...
/**
 * Plus Small icon from Heroicons.
 ...
 */
fun FlowContent.heroIconPlusSmall(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconPlusSmallOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Md -> heroIconPlusSmallSolid20
            HeroIconSize.Lg -> heroIconPlusSmallSolid24
            else -> heroIconPlusSmallSolid24
        }
    }
