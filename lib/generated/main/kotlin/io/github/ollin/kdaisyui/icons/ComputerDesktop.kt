...
// Source: heroicons/src/{16,20,24}/computer-desktop.svg
...
/**
 * Computer Desktop icon from Heroicons.
 ...
 */
fun FlowContent.heroIconComputerDesktop(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconComputerDesktopOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconComputerDesktopSolid16
            HeroIconSize.Md -> heroIconComputerDesktopSolid20
            HeroIconSize.Lg -> heroIconComputerDesktopSolid24
        }
    }
