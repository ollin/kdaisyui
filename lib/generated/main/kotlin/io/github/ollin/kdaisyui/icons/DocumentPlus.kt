...
// Source: heroicons/src/{16,20,24}/document-plus.svg
...
/**
 * Document Plus icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentPlus(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentPlusOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentPlusSolid16
            HeroIconSize.Md -> heroIconDocumentPlusSolid20
            HeroIconSize.Lg -> heroIconDocumentPlusSolid24
        }
    }
