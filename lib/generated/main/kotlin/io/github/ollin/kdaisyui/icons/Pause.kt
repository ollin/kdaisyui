...
// Source: heroicons/src/{16,20,24}/pause.svg
...
fun FlowContent.heroIconPause(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconPauseOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconPauseSolid16
            HeroIconSize.Md -> heroIconPauseSolid20
            HeroIconSize.Lg -> heroIconPauseSolid24
        }
    }
...
internal const val heroIconPauseOutline24 = """<path fill="none" d="M15.75 5.25L15.75 18.75M8.25 5.25V18.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />"""

internal const val heroIconPauseSolid16 = """<path d="M4.5 2C4.22386 2 4 2.22386 4 2.5V13.5C4 13.7761 4.22386 14 4.5 14H5.5C5.77614 14 6 13.7761 6 13.5V2.5C6 2.22386 5.77614 2 5.5 2H4.5Z" fill="black" />"""+
        """<path d="M10.5 2C10.2239 2 10 2.22386 10 2.5V13.5C10 13.7761 10.2239 14 10.5 14H11.5C11.7761 14 12 13.7761 12 13.5V2.5C12 2.22386 11.7761 2 11.5 2H10.5Z" fill="black" />"""

internal const val heroIconPauseSolid20 = """<path d="M5.75 3C5.33579 3 5 3.33579 5 3.75V16.25C5 16.6642 5.33579 17 5.75 17H7.25C7.66421 17 8 16.6642 8 16.25V3.75C8 3.33579 7.66421 3 7.25 3H5.75Z" fill="currentColor" />"""+
