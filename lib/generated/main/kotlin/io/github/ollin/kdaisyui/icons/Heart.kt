...
// Source: heroicons/src/{16,20,24}/heart.svg
...
fun FlowContent.heroIconHeart(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconHeartOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconHeartSolid16
            HeroIconSize.Md -> heroIconHeartSolid20
            HeroIconSize.Lg -> heroIconHeartSolid24
        }
    }
