...
// Source: heroicons/src/{16,20,24}/question-mark-circle.svg
...
/**
 * Question Mark Circle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconQuestionMarkCircle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconQuestionMarkCircleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconQuestionMarkCircleSolid16
            HeroIconSize.Md -> heroIconQuestionMarkCircleSolid20
            HeroIconSize.Lg -> heroIconQuestionMarkCircleSolid24
        }
    }
