...
// Source: heroicons/src/{16,20,24}/arrows-up-down.svg
...
/**
 * Arrows Up Down icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowsUpDown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowsUpDownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowsUpDownSolid16
            HeroIconSize.Md -> heroIconArrowsUpDownSolid20
            HeroIconSize.Lg -> heroIconArrowsUpDownSolid24
        }
    }
