...
// Source: heroicons/src/{16,20,24}/arrow-turn-left-down.svg
...
/**
 * Arrow Turn Left Down icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowTurnLeftDown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowTurnLeftDownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowTurnLeftDownSolid16
            HeroIconSize.Md -> heroIconArrowTurnLeftDownSolid20
            HeroIconSize.Lg -> heroIconArrowTurnLeftDownSolid24
        }
    }
