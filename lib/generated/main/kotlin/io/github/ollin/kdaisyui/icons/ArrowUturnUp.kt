...
// Source: heroicons/src/{16,20,24}/arrow-uturn-up.svg
...
/**
 * Arrow Uturn Up icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowUturnUp(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowUturnUpOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowUturnUpSolid16
            HeroIconSize.Md -> heroIconArrowUturnUpSolid20
            HeroIconSize.Lg -> heroIconArrowUturnUpSolid24
        }
    }
