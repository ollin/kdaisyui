...
// Source: heroicons/src/{16,20,24}/chart-bar-square.svg
...
/**
 * Chart Bar Square icon from Heroicons.
 ...
 */
fun FlowContent.heroIconChartBarSquare(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconChartBarSquareOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconChartBarSquareSolid16
            HeroIconSize.Md -> heroIconChartBarSquareSolid20
            HeroIconSize.Lg -> heroIconChartBarSquareSolid24
        }
    }
