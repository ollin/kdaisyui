...
// Source: heroicons/src/{16,20,24}/document-currency-bangladeshi.svg
...
/**
 * Document Currency Bangladeshi icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentCurrencyBangladeshi(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentCurrencyBangladeshiOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentCurrencyBangladeshiSolid16
            HeroIconSize.Md -> heroIconDocumentCurrencyBangladeshiSolid20
            HeroIconSize.Lg -> heroIconDocumentCurrencyBangladeshiSolid24
        }
    }
