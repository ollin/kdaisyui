...
// Source: heroicons/src/{16,20,24}/bars-arrow-down.svg
...
/**
 * Bars Arrow Down icon from Heroicons.
 ...
 */
fun FlowContent.heroIconBarsArrowDown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconBarsArrowDownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconBarsArrowDownSolid16
            HeroIconSize.Md -> heroIconBarsArrowDownSolid20
            HeroIconSize.Lg -> heroIconBarsArrowDownSolid24
        }
    }
...
internal const val heroIconBarsArrowDownOutline24 = """<path fill="none" d="M3 4.5H17.25M3 9H12.75M3 13.5H12.75M17.25 9V21M17.25 21L13.5 17.25M17.25 21L21 17.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />"""

internal const val heroIconBarsArrowDownSolid16 = """<path fill-rule="evenodd" clip-rule="evenodd" d="M2 2.75C2 2.33579 2.33579 2 2.75 2H12.25C12.6642 2 13 2.33579 13 2.75C13 3.16421 12.6642 3.5 12.25 3.5H2.75C2.33579 3.5 2 3.16421 2 2.75Z" fill="currentColor" />"""+
