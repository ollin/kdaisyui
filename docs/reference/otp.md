...
One-time password input for verification codes, typically four to six digits, used for two-factor authentication or passwordless login. Renders `<div class="otp ...">`.
