...
// Source: heroicons/src/{16,20,24}/list-bullet.svg
...
/**
 * List Bullet icon from Heroicons.
 ...
 */
fun FlowContent.heroIconListBullet(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconListBulletOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconListBulletSolid16
            HeroIconSize.Md -> heroIconListBulletSolid20
            HeroIconSize.Lg -> heroIconListBulletSolid24
        }
    }
...
internal const val heroIconListBulletOutline24 = """<path fill="none" d="M8.25 6.75H20.25M8.25 12H20.25M8.25 17.25H20.25M3.75 6.75H3.7575V6.7575H3.75V6.75ZM4.125 6.75C4.125 6.95711 3.95711 7.125 3.75 7.125C3.54289 7.125 3.375 6.95711 3.375 6.75C3.375 6.54289 3.54289 6.375 3.75 6.375C3.95711 6.375 4.125 6.54289 4.125 6.75ZM3.75 12H3.7575V12.0075H3.75V12ZM4.125 12C4.125 12.2071 3.95711 12.375 3.75 12.375C3.54289 12.375 3.375 12.2071 3.375 12C3.375 11.7929 3.54289 11.625 3.75 11.625C3.95711 11.625 4.125 11.7929 4.125 12ZM3.75 17.25H3.7575V17.2575H3.75V17.25ZM4.125 17.25C4.125 17.4571 3.95711 17.625 3.75 17.625C3.54289 17.625 3.375 17.4571 3.375 17.25C3.375 17.0429 3.54289 16.875 3.75 16.875C3.95711 16.875 4.125 17.0429 4.125 17.25Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />"""

internal const val heroIconListBulletSolid16 = """<path d="M3 4.75C3.55228 4.75 4 4.30228 4 3.75C4 3.19772 3.55228 2.75 3 2.75C2.44772 2.75 2 3.19772 2 3.75C2 4.30228 2.44772 4.75 3 4.75Z" fill="black" />"""+
        """<path d="M6.25 3C5.83579 3 5.5 3.33579 5.5 3.75C5.5 4.16421 5.83579 4.5 6.25 4.5H13.25C13.6642 4.5 14 4.16421 14 3.75C14 3.33579 13.6642 3 13.25 3H6.25Z" fill="black" />"""+
        """<path d="M6.25 7.25C5.83579 7.25 5.5 7.58579 5.5 8C5.5 8.41421 5.83579 8.75 6.25 8.75H13.25C13.6642 8.75 14 8.41421 14 8C14 7.58579 13.6642 7.25 13.25 7.25H6.25Z" fill="black" />"""+
        """<path d="M6.25 11.5C5.83579 11.5 5.5 11.8358 5.5 12.25C5.5 12.6642 5.83579 13 6.25 13H13.25C13.6642 13 14 12.6642 14 12.25C14 11.8358 13.6642 11.5 13.25 11.5H6.25Z" fill="black" />"""+
        """<path d="M4 12.25C4 12.8023 3.55228 13.25 3 13.25C2.44772 13.25 2 12.8023 2 12.25C2 11.6977 2.44772 11.25 3 11.25C3.55228 11.25 4 11.6977 4 12.25Z" fill="black" />"""+
        """<path d="M3 9C3.55228 9 4 8.55229 4 8C4 7.44772 3.55228 7 3 7C2.44772 7 2 7.44772 2 8C2 8.55229 2.44772 9 3 9Z" fill="black" />"""

internal const val heroIconListBulletSolid20 = """<path fill-rule="evenodd" clip-rule="evenodd" d="M6 4.75C6 4.33579 6.33579 4 6.75 4H17.25C17.6642 4 18 4.33579 18 4.75C18 5.16421 17.6642 5.5 17.25 5.5H6.75C6.33579 5.5 6 5.16421 6 4.75ZM6 10C6 9.58579 6.33579 9.25 6.75 9.25H17.25C17.6642 9.25 18 9.58579 18 10C18 10.4142 17.6642 10.75 17.25 10.75H6.75C6.33579 10.75 6 10.4142 6 10ZM6 15.25C6 14.8358 6.33579 14.5 6.75 14.5H17.25C17.6642 14.5 18 14.8358 18 15.25C18 15.6642 17.6642 16 17.25 16H6.75C6.33579 16 6 15.6642 6 15.25Z" fill="currentColor" />"""+
