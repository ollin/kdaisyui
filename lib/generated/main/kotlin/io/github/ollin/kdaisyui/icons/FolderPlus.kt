...
// Source: heroicons/src/{16,20,24}/folder-plus.svg
...
/**
 * Folder Plus icon from Heroicons.
 ...
 */
fun FlowContent.heroIconFolderPlus(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconFolderPlusOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconFolderPlusSolid16
            HeroIconSize.Md -> heroIconFolderPlusSolid20
            HeroIconSize.Lg -> heroIconFolderPlusSolid24
        }
    }
