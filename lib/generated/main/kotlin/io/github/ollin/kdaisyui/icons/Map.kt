...
// Source: heroicons/src/{16,20,24}/map.svg
...
fun FlowContent.heroIconMap(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconMapOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconMapSolid16
            HeroIconSize.Md -> heroIconMapSolid20
            HeroIconSize.Lg -> heroIconMapSolid24
        }
    }
