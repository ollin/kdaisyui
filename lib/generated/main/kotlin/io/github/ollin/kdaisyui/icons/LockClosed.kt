...
// Source: heroicons/src/{16,20,24}/lock-closed.svg
...
/**
 * Lock Closed icon from Heroicons.
 ...
 */
fun FlowContent.heroIconLockClosed(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconLockClosedOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconLockClosedSolid16
            HeroIconSize.Md -> heroIconLockClosedSolid20
            HeroIconSize.Lg -> heroIconLockClosedSolid24
        }
    }
