...
// Source: heroicons/src/{16,20,24}/document-duplicate.svg
...
/**
 * Document Duplicate icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentDuplicate(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentDuplicateOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentDuplicateSolid16
            HeroIconSize.Md -> heroIconDocumentDuplicateSolid20
            HeroIconSize.Lg -> heroIconDocumentDuplicateSolid24
        }
    }
...
internal const val heroIconDocumentDuplicateSolid24 = """<path d="M7.5 3.375C7.5 2.33947 8.33947 1.5 9.375 1.5H9.75C11.8211 1.5 13.5 3.17893 13.5 5.25V7.125C13.5 8.16053 14.3395 9 15.375 9H17.25C19.3211 9 21 10.6789 21 12.75V16.125C21 17.1605 20.1605 18 19.125 18H9.375C8.33947 18 7.5 17.1605 7.5 16.125V3.375Z" fill="currentColor" />"""+
