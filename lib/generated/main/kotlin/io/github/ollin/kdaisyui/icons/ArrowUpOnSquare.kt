...
// Source: heroicons/src/{16,20,24}/arrow-up-on-square.svg
...
/**
 * Arrow Up On Square icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowUpOnSquare(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowUpOnSquareOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowUpOnSquareSolid16
            HeroIconSize.Md -> heroIconArrowUpOnSquareSolid20
            HeroIconSize.Lg -> heroIconArrowUpOnSquareSolid24
        }
    }
