...
// Source: heroicons/src/{16,20,24}/arrow-turn-down-right.svg
...
/**
 * Arrow Turn Down Right icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowTurnDownRight(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowTurnDownRightOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowTurnDownRightSolid16
            HeroIconSize.Md -> heroIconArrowTurnDownRightSolid20
            HeroIconSize.Lg -> heroIconArrowTurnDownRightSolid24
        }
    }
