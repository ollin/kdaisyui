...
// Source: heroicons/src/{16,20,24}/information-circle.svg
...
/**
 * Information Circle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconInformationCircle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconInformationCircleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconInformationCircleSolid16
            HeroIconSize.Md -> heroIconInformationCircleSolid20
            HeroIconSize.Lg -> heroIconInformationCircleSolid24
        }
    }
