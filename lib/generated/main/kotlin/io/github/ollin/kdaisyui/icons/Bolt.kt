...
// Source: heroicons/src/{16,20,24}/bolt.svg
...
fun FlowContent.heroIconBolt(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconBoltOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconBoltSolid16
            HeroIconSize.Md -> heroIconBoltSolid20
            HeroIconSize.Lg -> heroIconBoltSolid24
        }
    }
