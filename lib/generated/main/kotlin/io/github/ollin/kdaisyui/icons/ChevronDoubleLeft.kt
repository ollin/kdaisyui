...
// Source: heroicons/src/{16,20,24}/chevron-double-left.svg
...
/**
 * Chevron Double Left icon from Heroicons.
 ...
 */
fun FlowContent.heroIconChevronDoubleLeft(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconChevronDoubleLeftOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconChevronDoubleLeftSolid16
            HeroIconSize.Md -> heroIconChevronDoubleLeftSolid20
            HeroIconSize.Lg -> heroIconChevronDoubleLeftSolid24
        }
    }
