...
// Source: heroicons/src/{16,20,24}/face-smile.svg
...
/**
 * Face Smile icon from Heroicons.
 ...
 */
fun FlowContent.heroIconFaceSmile(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconFaceSmileOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconFaceSmileSolid16
            HeroIconSize.Md -> heroIconFaceSmileSolid20
            HeroIconSize.Lg -> heroIconFaceSmileSolid24
        }
    }
