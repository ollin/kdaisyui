...
// Source: heroicons/src/{16,20,24}/command-line.svg
...
/**
 * Command Line icon from Heroicons.
 ...
 */
fun FlowContent.heroIconCommandLine(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconCommandLineOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconCommandLineSolid16
            HeroIconSize.Md -> heroIconCommandLineSolid20
            HeroIconSize.Lg -> heroIconCommandLineSolid24
        }
    }
