...
// Source: heroicons/src/{16,20,24}/hashtag.svg
 ...
 */
fun FlowContent.heroIconHashtag(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconHashtagOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconHashtagSolid16
            HeroIconSize.Md -> heroIconHashtagSolid20
            HeroIconSize.Lg -> heroIconHashtagSolid24
        }
    }
