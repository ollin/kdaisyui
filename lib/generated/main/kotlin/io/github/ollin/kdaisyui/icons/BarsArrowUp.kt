...
// Source: heroicons/src/{16,20,24}/bars-arrow-up.svg
...
/**
 * Bars Arrow Up icon from Heroicons.
 ...
 */
fun FlowContent.heroIconBarsArrowUp(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconBarsArrowUpOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconBarsArrowUpSolid16
            HeroIconSize.Md -> heroIconBarsArrowUpSolid20
            HeroIconSize.Lg -> heroIconBarsArrowUpSolid24
        }
    }
