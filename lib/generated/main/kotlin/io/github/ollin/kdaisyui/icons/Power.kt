...
// Source: heroicons/src/{16,20,24}/power.svg
...
fun FlowContent.heroIconPower(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconPowerOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconPowerSolid16
            HeroIconSize.Md -> heroIconPowerSolid20
            HeroIconSize.Lg -> heroIconPowerSolid24
        }
    }
