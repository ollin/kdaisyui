...
// Source: heroicons/src/{16,20,24}/document-arrow-up.svg
...
/**
 * Document Arrow Up icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentArrowUp(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentArrowUpOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentArrowUpSolid16
            HeroIconSize.Md -> heroIconDocumentArrowUpSolid20
            HeroIconSize.Lg -> heroIconDocumentArrowUpSolid24
        }
    }
