...
// Source: heroicons/src/{16,20,24}/home.svg
...
fun FlowContent.heroIconHome(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconHomeOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconHomeSolid16
            HeroIconSize.Md -> heroIconHomeSolid20
            HeroIconSize.Lg -> heroIconHomeSolid24
        }
    }
