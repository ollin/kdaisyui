...
// Source: heroicons/src/{16,20,24}/inbox.svg
...
fun FlowContent.heroIconInbox(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconInboxOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconInboxSolid16
            HeroIconSize.Md -> heroIconInboxSolid20
            HeroIconSize.Lg -> heroIconInboxSolid24
        }
    }
