...
// Source: heroicons/src/{16,20,24}/bell.svg
...
fun FlowContent.heroIconBell(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconBellOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconBellSolid16
            HeroIconSize.Md -> heroIconBellSolid20
            HeroIconSize.Lg -> heroIconBellSolid24
        }
    }
