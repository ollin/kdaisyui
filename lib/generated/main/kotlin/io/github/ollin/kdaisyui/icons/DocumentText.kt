...
// Source: heroicons/src/{16,20,24}/document-text.svg
...
/**
 * Document Text icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentText(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentTextOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentTextSolid16
            HeroIconSize.Md -> heroIconDocumentTextSolid20
            HeroIconSize.Lg -> heroIconDocumentTextSolid24
        }
    }
