...
// Source: heroicons/src/{16,20,24}/presentation-chart-line.svg
...
/**
 * Presentation Chart Line icon from Heroicons.
 ...
 */
fun FlowContent.heroIconPresentationChartLine(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconPresentationChartLineOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconPresentationChartLineSolid16
            HeroIconSize.Md -> heroIconPresentationChartLineSolid20
            HeroIconSize.Lg -> heroIconPresentationChartLineSolid24
        }
    }
