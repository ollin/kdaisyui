...
// Source: heroicons/src/{16,20,24}/forward.svg
 ...
 */
fun FlowContent.heroIconForward(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconForwardOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconForwardSolid16
            HeroIconSize.Md -> heroIconForwardSolid20
            HeroIconSize.Lg -> heroIconForwardSolid24
        }
    }
