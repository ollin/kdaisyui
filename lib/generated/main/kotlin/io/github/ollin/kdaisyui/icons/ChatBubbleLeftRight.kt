...
// Source: heroicons/src/{16,20,24}/chat-bubble-left-right.svg
...
/**
 * Chat Bubble Left Right icon from Heroicons.
 ...
 */
fun FlowContent.heroIconChatBubbleLeftRight(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconChatBubbleLeftRightOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconChatBubbleLeftRightSolid16
            HeroIconSize.Md -> heroIconChatBubbleLeftRightSolid20
            HeroIconSize.Lg -> heroIconChatBubbleLeftRightSolid24
        }
    }
