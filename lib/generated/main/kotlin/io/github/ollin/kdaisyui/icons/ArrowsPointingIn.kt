...
// Source: heroicons/src/{16,20,24}/arrows-pointing-in.svg
...
/**
 * Arrows Pointing In icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowsPointingIn(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowsPointingInOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowsPointingInSolid16
            HeroIconSize.Md -> heroIconArrowsPointingInSolid20
            HeroIconSize.Lg -> heroIconArrowsPointingInSolid24
        }
    }
