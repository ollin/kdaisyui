...
// Source: heroicons/src/{16,20,24}/x-circle.svg
 ...
 */
fun FlowContent.heroIconXCircle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconXCircleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconXCircleSolid16
            HeroIconSize.Md -> heroIconXCircleSolid20
            HeroIconSize.Lg -> heroIconXCircleSolid24
        }
    }
