...
// Source: heroicons/src/{16,20,24}/plus-circle.svg
...
/**
 * Plus Circle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconPlusCircle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconPlusCircleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconPlusCircleSolid16
            HeroIconSize.Md -> heroIconPlusCircleSolid20
            HeroIconSize.Lg -> heroIconPlusCircleSolid24
        }
    }
