...
// Source: heroicons/src/{16,20,24}/currency-yen.svg
...
/**
 * Currency Yen icon from Heroicons.
 ...
 */
fun FlowContent.heroIconCurrencyYen(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconCurrencyYenOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconCurrencyYenSolid16
            HeroIconSize.Md -> heroIconCurrencyYenSolid20
            HeroIconSize.Lg -> heroIconCurrencyYenSolid24
        }
    }
