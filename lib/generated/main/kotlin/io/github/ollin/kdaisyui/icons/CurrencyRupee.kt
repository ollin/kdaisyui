...
// Source: heroicons/src/{16,20,24}/currency-rupee.svg
...
/**
 * Currency Rupee icon from Heroicons.
 ...
 */
fun FlowContent.heroIconCurrencyRupee(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconCurrencyRupeeOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconCurrencyRupeeSolid16
            HeroIconSize.Md -> heroIconCurrencyRupeeSolid20
            HeroIconSize.Lg -> heroIconCurrencyRupeeSolid24
        }
    }
