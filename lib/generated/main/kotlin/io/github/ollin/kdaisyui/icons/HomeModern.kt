...
// Source: heroicons/src/{16,20,24}/home-modern.svg
...
/**
 * Home Modern icon from Heroicons.
 ...
 */
fun FlowContent.heroIconHomeModern(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconHomeModernOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconHomeModernSolid16
            HeroIconSize.Md -> heroIconHomeModernSolid20
            HeroIconSize.Lg -> heroIconHomeModernSolid24
        }
    }
