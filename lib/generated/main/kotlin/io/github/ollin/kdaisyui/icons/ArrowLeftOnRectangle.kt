...
// Source: heroicons/src/{16,20,24}/arrow-left-on-rectangle.svg
...
/**
 * Arrow Left On Rectangle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowLeftOnRectangle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowLeftOnRectangleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Md -> heroIconArrowLeftOnRectangleSolid20
            HeroIconSize.Lg -> heroIconArrowLeftOnRectangleSolid24
            else -> heroIconArrowLeftOnRectangleSolid24
        }
    }
