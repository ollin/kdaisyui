...
// Source: heroicons/src/{16,20,24}/arrow-down-circle.svg
...
/**
 * Arrow Down Circle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowDownCircle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowDownCircleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowDownCircleSolid16
            HeroIconSize.Md -> heroIconArrowDownCircleSolid20
            HeroIconSize.Lg -> heroIconArrowDownCircleSolid24
        }
    }
