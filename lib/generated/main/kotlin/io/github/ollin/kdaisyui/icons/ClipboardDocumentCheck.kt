...
// Source: heroicons/src/{16,20,24}/clipboard-document-check.svg
...
/**
 * Clipboard Document Check icon from Heroicons.
 ...
 */
fun FlowContent.heroIconClipboardDocumentCheck(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconClipboardDocumentCheckOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconClipboardDocumentCheckSolid16
            HeroIconSize.Md -> heroIconClipboardDocumentCheckSolid20
            HeroIconSize.Lg -> heroIconClipboardDocumentCheckSolid24
        }
    }
