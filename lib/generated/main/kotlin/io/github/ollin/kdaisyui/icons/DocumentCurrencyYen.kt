...
// Source: heroicons/src/{16,20,24}/document-currency-yen.svg
...
/**
 * Document Currency Yen icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentCurrencyYen(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentCurrencyYenOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentCurrencyYenSolid16
            HeroIconSize.Md -> heroIconDocumentCurrencyYenSolid20
            HeroIconSize.Lg -> heroIconDocumentCurrencyYenSolid24
        }
    }
