...
// Source: heroicons/src/{16,20,24}/chat-bubble-oval-left.svg
...
/**
 * Chat Bubble Oval Left icon from Heroicons.
 ...
 */
fun FlowContent.heroIconChatBubbleOvalLeft(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconChatBubbleOvalLeftOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconChatBubbleOvalLeftSolid16
            HeroIconSize.Md -> heroIconChatBubbleOvalLeftSolid20
            HeroIconSize.Lg -> heroIconChatBubbleOvalLeftSolid24
        }
    }
