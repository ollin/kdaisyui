...
// Source: heroicons/src/{16,20,24}/face-frown.svg
...
/**
 * Face Frown icon from Heroicons.
 ...
 */
fun FlowContent.heroIconFaceFrown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconFaceFrownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconFaceFrownSolid16
            HeroIconSize.Md -> heroIconFaceFrownSolid20
            HeroIconSize.Lg -> heroIconFaceFrownSolid24
        }
    }
