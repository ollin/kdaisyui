...
// Source: heroicons/src/{16,20,24}/chat-bubble-left.svg
...
/**
 * Chat Bubble Left icon from Heroicons.
 ...
 */
fun FlowContent.heroIconChatBubbleLeft(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconChatBubbleLeftOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconChatBubbleLeftSolid16
            HeroIconSize.Md -> heroIconChatBubbleLeftSolid20
            HeroIconSize.Lg -> heroIconChatBubbleLeftSolid24
        }
    }
