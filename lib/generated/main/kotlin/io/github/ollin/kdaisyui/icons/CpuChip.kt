...
// Source: heroicons/src/{16,20,24}/cpu-chip.svg
 ...
 */
fun FlowContent.heroIconCpuChip(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconCpuChipOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconCpuChipSolid16
            HeroIconSize.Md -> heroIconCpuChipSolid20
            HeroIconSize.Lg -> heroIconCpuChipSolid24
        }
    }
...
internal const val heroIconCpuChipSolid24 = """<path d="M16.5 7.5H7.5V16.5H16.5V7.5Z" fill="currentColor" />"""+
