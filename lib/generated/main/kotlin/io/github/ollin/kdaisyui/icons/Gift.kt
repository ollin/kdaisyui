...
// Source: heroicons/src/{16,20,24}/gift.svg
...
fun FlowContent.heroIconGift(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconGiftOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconGiftSolid16
            HeroIconSize.Md -> heroIconGiftSolid20
            HeroIconSize.Lg -> heroIconGiftSolid24
        }
    }
...
internal const val heroIconGiftOutline24 = """<path fill="none" d="M21 11.25V19.5C21 20.3284 20.3284 21 19.5 21H5.25C4.42157 21 3.75 20.3284 3.75 19.5V11.25M12 4.875C12 3.42525 10.8247 2.25 9.375 2.25C7.92525 2.25 6.75 3.42525 6.75 4.875C6.75 6.32475 7.92525 7.5 9.375 7.5C10.1095 7.5 12 7.5 12 7.5M12 4.875C12 5.59024 12 7.5 12 7.5M12 4.875C12 3.42525 13.1753 2.25 14.625 2.25C16.0747 2.25 17.25 3.42525 17.25 4.875C17.25 6.32475 16.0747 7.5 14.625 7.5C13.8905 7.5 12 7.5 12 7.5M12 7.5V21M3.375 11.25H21.375C21.9963 11.25 22.5 10.7463 22.5 10.125V8.625C22.5 8.00368 21.9963 7.5 21.375 7.5H3.375C2.75368 7.5 2.25 8.00368 2.25 8.625V10.125C2.25 10.7463 2.75368 11.25 3.375 11.25Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />"""

internal const val heroIconGiftSolid16 = """<path fill-rule="evenodd" clip-rule="evenodd" d="M3.75 3.5C3.75 4.0628 3.93597 4.58217 4.24982 5H2C1.44772 5 1 5.44772 1 6C1 6.55228 1.44772 7 2 7H7.25V5H8.75V7H14C14.5523 7 15 6.55228 15 6C15 5.44772 14.5523 5 14 5H11.7492C12.0631 4.58217 12.249 4.0628 12.249 3.5C12.249 2.11929 11.1297 1 9.74902 1C9.06791 1 8.45041 1.27238 7.99951 1.71416C7.54862 1.27238 6.93112 1 6.25 1C4.86929 1 3.75 2.11929 3.75 3.5ZM7.24902 3.5L7.2493 3.46229C7.22947 2.92748 6.78966 2.5 6.25 2.5C5.69772 2.5 5.25 2.94772 5.25 3.5C5.25 4.05228 5.69772 4.5 6.25 4.5H7.24936L7.24902 3.5ZM9.74902 2.5C9.20937 2.5 8.76955 2.92748 8.74972 3.46229L8.75 3.5V4.5H9.74902C10.3013 4.5 10.749 4.05228 10.749 3.5C10.749 2.94772 10.3013 2.5 9.74902 2.5Z" fill="black" />"""+
        """<path d="M7.25 8.5H2V12C2 13.1046 2.89543 14 4 14H7.25V8.5Z" fill="black" />"""+
        """<path d="M8.75 14V8.5H14V12C14 13.1046 13.1046 14 12 14H8.75Z" fill="black" />"""

internal const val heroIconGiftSolid20 = """<path fill-rule="evenodd" clip-rule="evenodd" d="M14.0002 6C14.314 5.58217 14.5 5.0628 14.5 4.5C14.5 3.11929 13.3807 2 12 2C11.1822 2 10.4561 2.39267 10 2.99976C9.54389 2.39267 8.8178 2 8 2C6.61929 2 5.5 3.11929 5.5 4.5C5.5 5.0628 5.68597 5.58217 5.99982 6H3.25C2.55964 6 2 6.55964 2 7.25V7.75C2 8.44036 2.55964 9 3.25 9H9.25V6H10.75V9H16.75C17.4404 9 18 8.44036 18 7.75V7.25C18 6.55964 17.4404 6 16.75 6H14.0002ZM13 4.5C13 5.05228 12.5523 5.5 12 5.5H11L11 4.5C11 3.94772 11.4477 3.5 12 3.5C12.5523 3.5 13 3.94772 13 4.5ZM7 4.5C7 5.05228 7.44772 5.5 8 5.5H9V4.5C9 3.94772 8.55228 3.5 8 3.5C7.44772 3.5 7 3.94772 7 4.5Z" fill="currentColor" />"""+
