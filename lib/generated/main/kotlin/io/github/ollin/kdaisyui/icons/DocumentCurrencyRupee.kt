...
// Source: heroicons/src/{16,20,24}/document-currency-rupee.svg
...
/**
 * Document Currency Rupee icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentCurrencyRupee(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentCurrencyRupeeOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentCurrencyRupeeSolid16
            HeroIconSize.Md -> heroIconDocumentCurrencyRupeeSolid20
            HeroIconSize.Lg -> heroIconDocumentCurrencyRupeeSolid24
        }
    }
