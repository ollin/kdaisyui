...
// Source: heroicons/src/{16,20,24}/identification.svg
...
/**
 * Identification icon from Heroicons.
 ...
 */
fun FlowContent.heroIconIdentification(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconIdentificationOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconIdentificationSolid16
            HeroIconSize.Md -> heroIconIdentificationSolid20
            HeroIconSize.Lg -> heroIconIdentificationSolid24
        }
    }
