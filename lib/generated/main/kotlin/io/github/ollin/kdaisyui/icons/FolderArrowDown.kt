...
// Source: heroicons/src/{16,20,24}/folder-arrow-down.svg
...
/**
 * Folder Arrow Down icon from Heroicons.
 ...
 */
fun FlowContent.heroIconFolderArrowDown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconFolderArrowDownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconFolderArrowDownSolid16
            HeroIconSize.Md -> heroIconFolderArrowDownSolid20
            HeroIconSize.Lg -> heroIconFolderArrowDownSolid24
        }
    }
