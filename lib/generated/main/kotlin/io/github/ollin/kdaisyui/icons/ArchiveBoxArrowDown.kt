...
// Source: heroicons/src/{16,20,24}/archive-box-arrow-down.svg
...
/**
 * Archive Box Arrow Down icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArchiveBoxArrowDown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArchiveBoxArrowDownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArchiveBoxArrowDownSolid16
            HeroIconSize.Md -> heroIconArchiveBoxArrowDownSolid20
            HeroIconSize.Lg -> heroIconArchiveBoxArrowDownSolid24
        }
    }
