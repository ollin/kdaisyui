...
// Source: heroicons/src/{16,20,24}/arrow-right-on-rectangle.svg
...
/**
 * Arrow Right On Rectangle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowRightOnRectangle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowRightOnRectangleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Md -> heroIconArrowRightOnRectangleSolid20
            HeroIconSize.Lg -> heroIconArrowRightOnRectangleSolid24
            else -> heroIconArrowRightOnRectangleSolid24
        }
    }
