...
// Source: heroicons/src/{16,20,24}/clipboard-document.svg
...
/**
 * Clipboard Document icon from Heroicons.
 ...
 */
fun FlowContent.heroIconClipboardDocument(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconClipboardDocumentOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconClipboardDocumentSolid16
            HeroIconSize.Md -> heroIconClipboardDocumentSolid20
            HeroIconSize.Lg -> heroIconClipboardDocumentSolid24
        }
    }
