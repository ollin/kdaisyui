...
// Source: heroicons/src/{16,20,24}/share.svg
...
fun FlowContent.heroIconShare(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconShareOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconShareSolid16
            HeroIconSize.Md -> heroIconShareSolid20
            HeroIconSize.Lg -> heroIconShareSolid24
        }
    }
