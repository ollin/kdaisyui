...
// Source: heroicons/src/{16,20,24}/window.svg
 ...
 */
fun FlowContent.heroIconWindow(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconWindowOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconWindowSolid16
            HeroIconSize.Md -> heroIconWindowSolid20
            HeroIconSize.Lg -> heroIconWindowSolid24
        }
    }
