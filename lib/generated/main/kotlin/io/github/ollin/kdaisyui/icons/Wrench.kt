...
// Source: heroicons/src/{16,20,24}/wrench.svg
 ...
 */
fun FlowContent.heroIconWrench(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconWrenchOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconWrenchSolid16
            HeroIconSize.Md -> heroIconWrenchSolid20
            HeroIconSize.Lg -> heroIconWrenchSolid24
        }
    }
