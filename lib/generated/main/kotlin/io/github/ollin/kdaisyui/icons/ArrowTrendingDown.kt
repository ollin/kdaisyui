...
// Source: heroicons/src/{16,20,24}/arrow-trending-down.svg
...
/**
 * Arrow Trending Down icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowTrendingDown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowTrendingDownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowTrendingDownSolid16
            HeroIconSize.Md -> heroIconArrowTrendingDownSolid20
            HeroIconSize.Lg -> heroIconArrowTrendingDownSolid24
        }
    }
