...
// Source: heroicons/src/{16,20,24}/chat-bubble-left-ellipsis.svg
...
/**
 * Chat Bubble Left Ellipsis icon from Heroicons.
 ...
 */
fun FlowContent.heroIconChatBubbleLeftEllipsis(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconChatBubbleLeftEllipsisOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconChatBubbleLeftEllipsisSolid16
            HeroIconSize.Md -> heroIconChatBubbleLeftEllipsisSolid20
            HeroIconSize.Lg -> heroIconChatBubbleLeftEllipsisSolid24
        }
    }
