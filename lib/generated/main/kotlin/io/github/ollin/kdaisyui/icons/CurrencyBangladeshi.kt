...
// Source: heroicons/src/{16,20,24}/currency-bangladeshi.svg
...
/**
 * Currency Bangladeshi icon from Heroicons.
 ...
 */
fun FlowContent.heroIconCurrencyBangladeshi(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconCurrencyBangladeshiOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconCurrencyBangladeshiSolid16
            HeroIconSize.Md -> heroIconCurrencyBangladeshiSolid20
            HeroIconSize.Lg -> heroIconCurrencyBangladeshiSolid24
        }
    }
