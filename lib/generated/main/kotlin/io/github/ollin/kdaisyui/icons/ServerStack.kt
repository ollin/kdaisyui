...
// Source: heroicons/src/{16,20,24}/server-stack.svg
...
/**
 * Server Stack icon from Heroicons.
 ...
 */
fun FlowContent.heroIconServerStack(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconServerStackOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconServerStackSolid16
            HeroIconSize.Md -> heroIconServerStackSolid20
            HeroIconSize.Lg -> heroIconServerStackSolid24
        }
    }
...
internal const val heroIconServerStackSolid24 = """<path d="M5.50701 4.04763C6.07695 3.38269 6.909 3 7.78478 3H16.2151C17.0908 3 17.9229 3.38269 18.4928 4.04763L20.2147 6.05645C19.9819 6.0193 19.7432 6 19.4999 6H4.49992C4.25668 6 4.01794 6.0193 3.78516 6.05645L5.50701 4.04763Z" fill="currentColor" />"""+
