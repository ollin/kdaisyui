...
// Source: heroicons/src/{16,20,24}/bell-snooze.svg
...
/**
 * Bell Snooze icon from Heroicons.
 ...
 */
fun FlowContent.heroIconBellSnooze(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconBellSnoozeOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconBellSnoozeSolid16
            HeroIconSize.Md -> heroIconBellSnoozeSolid20
            HeroIconSize.Lg -> heroIconBellSnoozeSolid24
        }
    }
