...
// Source: heroicons/src/{16,20,24}/h1.svg
...
fun FlowContent.heroIconH1(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconH1Outline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconH1Solid16
            HeroIconSize.Md -> heroIconH1Solid20
            HeroIconSize.Lg -> heroIconH1Solid24
        }
    }
