...
// Source: heroicons/src/{16,20,24}/presentation-chart-bar.svg
...
/**
 * Presentation Chart Bar icon from Heroicons.
 ...
 */
fun FlowContent.heroIconPresentationChartBar(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconPresentationChartBarOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconPresentationChartBarSolid16
            HeroIconSize.Md -> heroIconPresentationChartBarSolid20
            HeroIconSize.Lg -> heroIconPresentationChartBarSolid24
        }
    }
