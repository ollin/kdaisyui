...
// Source: heroicons/src/{16,20,24}/arrow-trending-up.svg
...
/**
 * Arrow Trending Up icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowTrendingUp(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowTrendingUpOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowTrendingUpSolid16
            HeroIconSize.Md -> heroIconArrowTrendingUpSolid20
            HeroIconSize.Lg -> heroIconArrowTrendingUpSolid24
        }
    }
