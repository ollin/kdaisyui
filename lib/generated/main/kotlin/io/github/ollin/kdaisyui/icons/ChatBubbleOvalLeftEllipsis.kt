...
// Source: heroicons/src/{16,20,24}/chat-bubble-oval-left-ellipsis.svg
...
/**
 * Chat Bubble Oval Left Ellipsis icon from Heroicons.
 ...
 */
fun FlowContent.heroIconChatBubbleOvalLeftEllipsis(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconChatBubbleOvalLeftEllipsisOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconChatBubbleOvalLeftEllipsisSolid16
            HeroIconSize.Md -> heroIconChatBubbleOvalLeftEllipsisSolid20
            HeroIconSize.Lg -> heroIconChatBubbleOvalLeftEllipsisSolid24
        }
    }
