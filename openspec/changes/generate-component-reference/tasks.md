...
- [x] 5.3 `^ F (internal)` Generate all 66 pages plus the index, and commit them.
- [x] 5.4 `. d` Read the full diff of all 66 pages against what they replaced. Every difference
