...
// Source: heroicons/src/{16,20,24}/eye-slash.svg
 ...
 */
fun FlowContent.heroIconEyeSlash(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconEyeSlashOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconEyeSlashSolid16
            HeroIconSize.Md -> heroIconEyeSlashSolid20
            HeroIconSize.Lg -> heroIconEyeSlashSolid24
        }
    }
