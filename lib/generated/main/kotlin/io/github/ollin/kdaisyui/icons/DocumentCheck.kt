...
// Source: heroicons/src/{16,20,24}/document-check.svg
...
/**
 * Document Check icon from Heroicons.
 ...
 */
fun FlowContent.heroIconDocumentCheck(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconDocumentCheckOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconDocumentCheckSolid16
            HeroIconSize.Md -> heroIconDocumentCheckSolid20
            HeroIconSize.Lg -> heroIconDocumentCheckSolid24
        }
    }
