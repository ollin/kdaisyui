...
// Source: heroicons/src/{16,20,24}/arrows-pointing-out.svg
...
/**
 * Arrows Pointing Out icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowsPointingOut(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowsPointingOutOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowsPointingOutSolid16
            HeroIconSize.Md -> heroIconArrowsPointingOutSolid20
            HeroIconSize.Lg -> heroIconArrowsPointingOutSolid24
        }
    }
