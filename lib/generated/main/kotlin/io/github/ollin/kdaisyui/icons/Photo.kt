...
// Source: heroicons/src/{16,20,24}/photo.svg
...
fun FlowContent.heroIconPhoto(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconPhotoOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconPhotoSolid16
            HeroIconSize.Md -> heroIconPhotoSolid20
            HeroIconSize.Lg -> heroIconPhotoSolid24
        }
    }
