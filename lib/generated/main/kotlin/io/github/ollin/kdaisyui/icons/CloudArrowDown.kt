...
// Source: heroicons/src/{16,20,24}/cloud-arrow-down.svg
...
/**
 * Cloud Arrow Down icon from Heroicons.
 ...
 */
fun FlowContent.heroIconCloudArrowDown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconCloudArrowDownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconCloudArrowDownSolid16
            HeroIconSize.Md -> heroIconCloudArrowDownSolid20
            HeroIconSize.Lg -> heroIconCloudArrowDownSolid24
        }
    }
