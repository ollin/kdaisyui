...
// Source: heroicons/src/{16,20,24}/server.svg
 ...
 */
fun FlowContent.heroIconServer(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconServerOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconServerSolid16
            HeroIconSize.Md -> heroIconServerSolid20
            HeroIconSize.Lg -> heroIconServerSolid24
        }
    }
...
internal const val heroIconServerOutline24 = """<path fill="none" d="M21.75 17.25V17.0223C21.75 16.6753 21.7099 16.3294 21.6304 15.9916L19.3622 6.35199C19.0035 4.82745 17.6431 3.75 16.077 3.75H7.92305C6.35688 3.75 4.99648 4.82745 4.63777 6.35199L2.36962 15.9916C2.29014 16.3294 2.25 16.6753 2.25 17.0223V17.25M21.75 17.25C21.75 18.9069 20.4069 20.25 18.75 20.25H5.25C3.59315 20.25 2.25 18.9069 2.25 17.25M21.75 17.25C21.75 15.5931 20.4069 14.25 18.75 14.25H5.25C3.59315 14.25 2.25 15.5931 2.25 17.25M18.75 17.25H18.7575V17.2575H18.75V17.25ZM15.75 17.25H15.7575V17.2575H15.75V17.25Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />"""

internal const val heroIconServerSolid16 = """<path d="M3.66489 3.58798C3.85973 2.66249 4.67621 2 5.62199 2H10.3764C11.3222 2 12.1387 2.66249 12.3335 3.58798L13.432 8.80576C12.9947 8.60929 12.5097 8.5 11.9992 8.5H3.9992C3.4887 8.5 3.00373 8.60929 2.56641 8.80576L3.66489 3.58798Z" fill="black" />"""+
        """<path fill-rule="evenodd" clip-rule="evenodd" d="M4 10C2.89543 10 2 10.8954 2 12C2 13.1046 2.89543 14 4 14H12C13.1046 14 14 13.1046 14 12C14 10.8954 13.1046 10 12 10H4ZM12 12.75C12.4142 12.75 12.75 12.4142 12.75 12C12.75 11.5858 12.4142 11.25 12 11.25C11.5858 11.25 11.25 11.5858 11.25 12C11.25 12.4142 11.5858 12.75 12 12.75ZM9.75 12C9.75 12.4142 9.41421 12.75 9 12.75C8.58579 12.75 8.25 12.4142 8.25 12C8.25 11.5858 8.58579 11.25 9 11.25C9.41421 11.25 9.75 11.5858 9.75 12Z" fill="black" />"""

internal const val heroIconServerSolid20 = """<path d="M4.63196 3.53326C4.84778 2.63402 5.65196 2 6.57674 2H13.4231C14.3479 2 15.1521 2.63401 15.3679 3.53325L17.3441 11.7674C16.9303 11.5951 16.4762 11.5 15.9999 11.5H3.99994C3.52368 11.5 3.06963 11.5951 2.65576 11.7674L4.63196 3.53326Z" fill="currentColor" />"""+
