...
// Source: heroicons/src/{16,20,24}/musical-note.svg
...
/**
 * Musical Note icon from Heroicons.
 ...
 */
fun FlowContent.heroIconMusicalNote(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconMusicalNoteOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconMusicalNoteSolid16
            HeroIconSize.Md -> heroIconMusicalNoteSolid20
            HeroIconSize.Lg -> heroIconMusicalNoteSolid24
        }
    }
