...
// Source: heroicons/src/{16,20,24}/arrow-down-tray.svg
...
/**
 * Arrow Down Tray icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowDownTray(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowDownTrayOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowDownTraySolid16
            HeroIconSize.Md -> heroIconArrowDownTraySolid20
            HeroIconSize.Lg -> heroIconArrowDownTraySolid24
        }
    }
