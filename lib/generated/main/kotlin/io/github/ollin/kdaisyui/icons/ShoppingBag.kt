...
// Source: heroicons/src/{16,20,24}/shopping-bag.svg
 ...
 */
fun FlowContent.heroIconShoppingBag(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconShoppingBagOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconShoppingBagSolid16
            HeroIconSize.Md -> heroIconShoppingBagSolid20
            HeroIconSize.Lg -> heroIconShoppingBagSolid24
        }
    }
