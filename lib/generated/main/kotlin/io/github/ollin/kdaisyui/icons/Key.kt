...
// Source: heroicons/src/{16,20,24}/key.svg
...
fun FlowContent.heroIconKey(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconKeyOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconKeySolid16
            HeroIconSize.Md -> heroIconKeySolid20
            HeroIconSize.Lg -> heroIconKeySolid24
        }
    }
