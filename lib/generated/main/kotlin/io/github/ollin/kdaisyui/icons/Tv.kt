...
// Source: heroicons/src/{16,20,24}/tv.svg
...
fun FlowContent.heroIconTv(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconTvOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconTvSolid16
            HeroIconSize.Md -> heroIconTvSolid20
            HeroIconSize.Lg -> heroIconTvSolid24
        }
    }
...
internal const val heroIconTvOutline24 = """<path fill="none" d="M6 20.25H18M10.5 17.25V20.25M13.5 17.25V20.25M3.375 17.25H20.625C21.2463 17.25 21.75 16.7463 21.75 16.125V4.875C21.75 4.25368 21.2463 3.75 20.625 3.75H3.375C2.75368 3.75 2.25 4.25368 2.25 4.875V16.125C2.25 16.7463 2.75368 17.25 3.375 17.25Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />"""

internal const val heroIconTvSolid16 = """<path d="M12 5H4V9H12V5Z" fill="black" />"""+
        """<path fill-rule="evenodd" clip-rule="evenodd" d="M1 3C1 2.44772 1.44772 2 2 2H14C14.5523 2 15 2.44772 15 3V11C15 11.5523 14.5523 12 14 12H10V13.5H12.25C12.6642 13.5 13 13.8358 13 14.25C13 14.6642 12.6642 15 12.25 15H3.75C3.33579 15 3 14.6642 3 14.25C3 13.8358 3.33579 13.5 3.75 13.5H6V12H2C1.44772 12 1 11.5523 1 11V3ZM2.5 10.5V3.5H13.5V10.5H2.5Z" fill="black" />"""

internal const val heroIconTvSolid20 = """<path d="M4 5H16V12H4V5Z" fill="currentColor" />"""+
        """<path fill-rule="evenodd" clip-rule="evenodd" d="M1 3.5C1 2.67157 1.67157 2 2.5 2H17.5C18.3284 2 19 2.67157 19 3.5V13.5C19 14.3284 18.3284 15 17.5 15H12V16.5H15.25C15.6642 16.5 16 16.8358 16 17.25C16 17.6642 15.6642 18 15.25 18H4.75C4.33579 18 4 17.6642 4 17.25C4 16.8358 4.33579 16.5 4.75 16.5H8V15H2.5C1.67157 15 1 14.3284 1 13.5V3.5ZM17.5 3.5L2.5 3.5V13.5H17.5V3.5Z" fill="currentColor" />"""

internal const val heroIconTvSolid24 = """<path d="M19.5 6H4.5V15H19.5V6Z" fill="currentColor" />"""+
