...
// Source: heroicons/src/{16,20,24}/arrow-right-start-on-rectangle.svg
...
/**
 * Arrow Right Start On Rectangle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowRightStartOnRectangle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowRightStartOnRectangleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowRightStartOnRectangleSolid16
            HeroIconSize.Md -> heroIconArrowRightStartOnRectangleSolid20
            HeroIconSize.Lg -> heroIconArrowRightStartOnRectangleSolid24
        }
    }
