...
// Source: heroicons/src/{16,20,24}/chat-bubble-bottom-center-text.svg
...
/**
 * Chat Bubble Bottom Center Text icon from Heroicons.
 ...
 */
fun FlowContent.heroIconChatBubbleBottomCenterText(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconChatBubbleBottomCenterTextOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconChatBubbleBottomCenterTextSolid16
            HeroIconSize.Md -> heroIconChatBubbleBottomCenterTextSolid20
            HeroIconSize.Lg -> heroIconChatBubbleBottomCenterTextSolid24
        }
    }
