...
// Source: heroicons/src/{16,20,24}/arrow-uturn-down.svg
...
/**
 * Arrow Uturn Down icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowUturnDown(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowUturnDownOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowUturnDownSolid16
            HeroIconSize.Md -> heroIconArrowUturnDownSolid20
            HeroIconSize.Lg -> heroIconArrowUturnDownSolid24
        }
    }
