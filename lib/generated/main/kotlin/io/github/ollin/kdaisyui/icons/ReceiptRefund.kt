...
// Source: heroicons/src/{16,20,24}/receipt-refund.svg
...
/**
 * Receipt Refund icon from Heroicons.
 ...
 */
fun FlowContent.heroIconReceiptRefund(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconReceiptRefundOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconReceiptRefundSolid16
            HeroIconSize.Md -> heroIconReceiptRefundSolid20
            HeroIconSize.Lg -> heroIconReceiptRefundSolid24
        }
    }
