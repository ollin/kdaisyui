...
// Source: heroicons/src/{16,20,24}/arrows-right-left.svg
...
/**
 * Arrows Right Left icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowsRightLeft(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowsRightLeftOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowsRightLeftSolid16
            HeroIconSize.Md -> heroIconArrowsRightLeftSolid20
            HeroIconSize.Lg -> heroIconArrowsRightLeftSolid24
        }
    }
