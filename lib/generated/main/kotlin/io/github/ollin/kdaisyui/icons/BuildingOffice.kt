...
// Source: heroicons/src/{16,20,24}/building-office.svg
...
/**
 * Building Office icon from Heroicons.
 ...
 */
fun FlowContent.heroIconBuildingOffice(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconBuildingOfficeOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconBuildingOfficeSolid16
            HeroIconSize.Md -> heroIconBuildingOfficeSolid20
            HeroIconSize.Lg -> heroIconBuildingOfficeSolid24
        }
    }
