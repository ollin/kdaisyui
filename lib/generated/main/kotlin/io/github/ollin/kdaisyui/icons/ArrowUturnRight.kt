...
// Source: heroicons/src/{16,20,24}/arrow-uturn-right.svg
...
/**
 * Arrow Uturn Right icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowUturnRight(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowUturnRightOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowUturnRightSolid16
            HeroIconSize.Md -> heroIconArrowUturnRightSolid20
            HeroIconSize.Lg -> heroIconArrowUturnRightSolid24
        }
    }
