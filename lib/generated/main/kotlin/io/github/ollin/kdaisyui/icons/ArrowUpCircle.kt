...
// Source: heroicons/src/{16,20,24}/arrow-up-circle.svg
...
/**
 * Arrow Up Circle icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowUpCircle(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowUpCircleOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowUpCircleSolid16
            HeroIconSize.Md -> heroIconArrowUpCircleSolid20
            HeroIconSize.Lg -> heroIconArrowUpCircleSolid24
        }
    }
