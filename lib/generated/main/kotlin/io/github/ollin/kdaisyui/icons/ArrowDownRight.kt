...
// Source: heroicons/src/{16,20,24}/arrow-down-right.svg
...
/**
 * Arrow Down Right icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowDownRight(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowDownRightOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowDownRightSolid16
            HeroIconSize.Md -> heroIconArrowDownRightSolid20
            HeroIconSize.Lg -> heroIconArrowDownRightSolid24
        }
    }
