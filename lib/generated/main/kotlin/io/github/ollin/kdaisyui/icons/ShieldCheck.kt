...
// Source: heroicons/src/{16,20,24}/shield-check.svg
 ...
 */
fun FlowContent.heroIconShieldCheck(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconShieldCheckOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconShieldCheckSolid16
            HeroIconSize.Md -> heroIconShieldCheckSolid20
            HeroIconSize.Lg -> heroIconShieldCheckSolid24
        }
    }
