...
// Source: heroicons/src/{16,20,24}/arrow-uturn-left.svg
...
/**
 * Arrow Uturn Left icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowUturnLeft(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowUturnLeftOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowUturnLeftSolid16
            HeroIconSize.Md -> heroIconArrowUturnLeftSolid20
            HeroIconSize.Lg -> heroIconArrowUturnLeftSolid24
        }
    }
