...
// Source: heroicons/src/{16,20,24}/arrow-left.svg
...
/**
 * Arrow Left icon from Heroicons.
 ...
 */
fun FlowContent.heroIconArrowLeft(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconArrowLeftOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconArrowLeftSolid16
            HeroIconSize.Md -> heroIconArrowLeftSolid20
            HeroIconSize.Lg -> heroIconArrowLeftSolid24
        }
    }
