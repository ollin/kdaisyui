...
// Source: heroicons/src/{16,20,24}/cloud-arrow-up.svg
...
/**
 * Cloud Arrow Up icon from Heroicons.
 ...
 */
fun FlowContent.heroIconCloudArrowUp(
    ...
    val svgContent = when (variant) {
        HeroIconVariant.Outline -> heroIconCloudArrowUpOutline24
        HeroIconVariant.Solid -> when (size) {
            HeroIconSize.Sm -> heroIconCloudArrowUpSolid16
            HeroIconSize.Md -> heroIconCloudArrowUpSolid20
            HeroIconSize.Lg -> heroIconCloudArrowUpSolid24
        }
    }
